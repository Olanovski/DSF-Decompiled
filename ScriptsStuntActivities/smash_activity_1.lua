...
cards.Missions["Smash activity 1"] = {
  FileVersion = "2",
  name = "Smash activity 1",
  title = "ID:244204",
  MissionID = "6573",
  ...
  cardInstances = {
    Actors = {
      Player = {
        [1] = {
          ...
          blockTow = false,
          routeName = "Smash activity 1 route",
          avoidAttacks = false,
    ...
    MissionSettings = {
      ["Smash activity 1"] = {
        [1] = {
          ...
          ["Mission props"] = "Smash activity 1",
          ["Enable traffic at mission end"] = true,
          ["Start location"] = "SmashActivity1",
    ...
    SpawnTypes = {
      ["Set position"] = {
        [1] = {
          ["Spawn location"] = "SmashPlayerSpawn1",
