...
missionSetupData["Tanker on fire activity 2"] = {}
local tankerStartWaterLevel = 130
...
missionSetupData["Tanker on fire activity 2"].taskCreatorFunctionLookups = {
  ["Tanker team"] = tankerTask,
  ["Fire team"] = fireTask,
  ["Player team"] = playerTask
}
missionSetupData["Tanker on fire activity 2"].initiate = function(instance)
  ...
  instance.challenge.actorPool["Fire team member 3"].spawn.relativeToVehicle.actor = "Tanker5"
...
missionSetupData["Tanker on fire activity 2"].update = nil
taskCompleteData["Tanker on fire activity 2"] = {}
taskCompleteData["Tanker on fire activity 2"].taskComplete = function(taskObject, task)
  local params = {
  ...
  if task.success then
    ...
    elseif task.specialName == "In first truck" then
      task.instance.taskObjectsByActorID.Tanker1.coreData.agent.iconsVisible = true
    elseif task.specialName == "Congrats 1" then
      ...
      task.instance.taskObjectsByActorID.Tanker2.coreData.agent.iconsVisible = false
      task.instance.taskObjectsByActorID.Tanker2.namedTasks["Tanker payload"].networkVars.payload = 20
    ...
    elseif task.specialName == "In second truck" then
      task.instance.taskObjectsByActorID.Tanker2.coreData.agent.iconsVisible = true
    elseif task.specialName == "Congrats 2" then
      ...
      task.instance.taskObjectsByActorID.Tanker3.namedTasks["Tanker payload"].networkVars.payload = 40
      task.instance.taskObjectsByActorID.Tanker4.namedTasks["Tanker payload"].networkVars.payload = 50
      task.instance.taskObjectsByActorID.Tanker5.namedTasks["Tanker payload"].networkVars.payload = 55
      ...
      civilianTraffic.AddScriptLaneTrackInterloper(task.instance.taskObjectsByActorID.Tanker4.coreData.agent.gameVehicle, LaneTrackFollowerRejectionCallback)
      civilianTraffic.AddScriptLaneTrackInterloper(task.instance.taskObjectsByActorID.Tanker5.coreData.agent.gameVehicle, LaneTrackFollowerRejectionCallback)
...
missionEndCallback["Tanker on fire activity 2"] = function(instance)
  Sound.ClearAllSourceVehicles()
