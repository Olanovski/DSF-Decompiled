...
cards.Missions["Checkpoint activity 6"] = {
  FileVersion = "2",
  name = "Checkpoint activity 6",
  title = "ID:244213",
  MissionID = "4525",
  ...
  cardInstances = {
    Actors = {
      Player = {
        [1] = {
          ...
          previewMovie = " ",
          routeName = "Checkpoint activity 6 route",
    ...
    MissionSettings = {
      ["Checkpoint activity 6"] = {
        [1] = {
          ["Disable auto-zap out on mission complete"] = false,
          ["Enable traffic at mission end"] = true,
          ["Start location"] = "CheckpointActivity6",
          ["disablePlayerIgnoring"] = false,
          ["Spawn type"] = "Always active",
          ["Delete task object on reject preview"] = false,
          ["Hud logic file"] = "Checkpoint activity 6 hud",
