...
cards.Missions["Checkpoint activity 1"] = {
  FileVersion = "2",
  name = "Checkpoint activity 1",
  title = "ID:244208",
  MissionID = "1965",
  ...
  cardInstances = {
    Actors = {
      Player = {
        [1] = {
          ...
          previewMovie = " ",
          routeName = "Checkpoint activity 1 route",
    ...
    MissionSettings = {
      ["Checkpoint activity 1"] = {
        [1] = {
          ...
          ["Hud logic file"] = "Checkpoint activity 1 hud",
          ["Disable traffic"] = false,
          ["Enable traffic at mission end"] = true,
          ["Start location"] = "CheckpointActivity1",
    ...
    MissionTypes = {
      ["Generic checkpoint activity"] = {
        [1] = {
          ["Substracted willpower per second"] = 50,
          ["Willpower per checkpoint"] = 500,
          ["Maximum willpower"] = 2000,
          ["Player Team"] = {
            instance = 1,
            type = "Teams",
            name = "Player Team"
