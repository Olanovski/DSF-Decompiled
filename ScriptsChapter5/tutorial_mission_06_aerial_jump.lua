...
cards.Missions["Tutorial Mission 06 Aerial Jump"] = {
  FileVersion = "2",
  name = "Tutorial Mission 06 Aerial Jump",
  title = "TUTORIAL MISSION 06 AERIAL JUMP ",
  MissionID = "6388",
  ...
  cardInstances = {
    ...
    MissionSettings = {
      ["New MissionSettings"] = {
        [1] = {
          ...
          ["Hud logic file"] = "Tutorial mission 06 aerial jump HUD",
          ["Disable traffic"] = false,
          ["Enable traffic at mission end"] = true,
          ["disablePlayerIgnoring"] = false,
          ["Audio logic file"] = "Shift tutorial level 3",
    ...
    MissionTypes = {
      ["New Tutorial mission 06 aerial jump"] = {
        [1] = {
          ["Tanner team"] = {
            instance = 1,
            type = "Teams",
