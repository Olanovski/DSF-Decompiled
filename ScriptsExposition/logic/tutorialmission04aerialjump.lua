...
missionSetupData["Tutorial mission 04 aerial jump"] = {}
...
missionSetupData["Tutorial mission 04 aerial jump"].taskCreatorFunctionLookups = {
...
missionSetupData["Tutorial mission 04 aerial jump"].initiate = function(instance)
...
missionSetupData["Tutorial mission 04 aerial jump"].update = nil
missionEndCallback["Tutorial mission 04 aerial jump"] = function(instance)
...
taskCompleteData["Tutorial mission 04 aerial jump"] = {}
taskCompleteData["Tutorial mission 04 aerial jump"].taskComplete = function(taskObject, task)
  local function completeTask()
    progressionSystem.endTutorial()
    progressionSystem.challengeComplete(task.instance, task.agent.matrix)
  end
  if task.specialName == "Tutorial Start" then
    CutsceneFiles.tutorials.playTutorial("ID:236222", nil, nil, true)
    localPlayer:blockAbility("zap", false)
