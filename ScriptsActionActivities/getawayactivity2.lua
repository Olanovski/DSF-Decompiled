...
cards.Missions.GetawayActivity2 = {
  FileVersion = "2",
  name = "GetawayActivity2",
  title = "ID:244231",
  MissionID = "20302",
  ...
  cardInstances = {
    ...
    SpawnTypes = {
      ["Opponent spawn"] = {
        [1] = {
          ["Spawn location"] = "GetawayActivity2 Opponent spawn",
      ...
      ["Player spawn"] = {
        [1] = {
          ["Spawn location"] = "GetawayActivity2 Player spawn",
          ["Snap to closest road"] = false
        },
        ["name"] = "Set position"
      }
    ...
    MissionSettings = {
      ["New MissionSettings"] = {
        [1] = {
          ...
          ["Start location"] = "GetawayActivity2 start",
    ...
    MissionTypes = {
      ["New Felony getaway activity"] = {
        [1] = {
          ...
          ["End hotspot position"] = "GetawayActivity2 end",
