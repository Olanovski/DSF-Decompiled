...
cards.Missions.ChaseActivity2 = {
  ...
  cardInstances = {
    ...
    MissionSettings = {
      ["New MissionSettings"] = {
        [1] = {
          ...
          ["Start location"] = "ChaseActivity2 start",
    ...
    SpawnTypes = {
      ...
      ["Player spawn"] = {
        [1] = {
          ["Spawn location"] = "ChaseActivity2 Player spawn",
      ...
      ["Opponent spawn"] = {
        [1] = {
          ["Spawn location"] = "ChaseActivity2 Opponent spawn",
          ["Snap to closest road"] = false
        },
        ["name"] = "Set position"
      }
