...
cards.Missions.ChaseActivity1 = {
  ...
  cardInstances = {
    ...
    MissionSettings = {
      ["New MissionSettings"] = {
        [1] = {
          ...
          ["Start location"] = "ChaseActivity1 start",
    ...
    SpawnTypes = {
      ...
      ["Player spawn"] = {
        [1] = {
          ["Spawn location"] = "ChaseActivity1 Player spawn",
      ...
      ["Opponent spawn"] = {
        [1] = {
          ["Spawn location"] = "ChaseActivity1 Opponent spawn",
          ["Snap to closest road"] = false
        },
        ["name"] = "Set position"
      }
