...
cards.Missions.StreetraceTakedownActivity5 = {
  FileVersion = "2",
  name = "StreetraceTakedownActivity5",
  title = "ID:244238",
  MissionID = "21712",
  ...
  cardInstances = {
    Actors = {
      Racer2 = {
        [1] = {
          ...
          routeName = "StreetraceTakedownActivity5Route",
    ...
    MissionSettings = {
      ["New MissionSettings"] = {
        [1] = {
          ...
          ["Start location"] = "StreetraceTakedownActivity5",
    ...
    SpawnTypes = {
      ["New Set position"] = {
        [1] = {
          ["Spawn location"] = "StreetraceTakedownActivity5Player",
