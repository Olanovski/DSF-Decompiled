...
cards.Missions.ChaseActivity4 = {
  ...
  cardInstances = {
    ...
    MissionSettings = {
      ["New MissionSettings"] = {
        [1] = {
          ...
          ["Start location"] = "ChaseActivity4 start",
    ...
    SpawnTypes = {
      ...
      ["Player spawn"] = {
        [1] = {
          ["Spawn location"] = "ChaseActivity4 Player spawn",
      ...
      ["Opponent spawn"] = {
        [1] = {
          ["Spawn location"] = "ChaseActivity4 Opponent spawn",
          ["Snap to closest road"] = false
        },
        ["name"] = "Set position"
      }
