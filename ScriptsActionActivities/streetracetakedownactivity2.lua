...
cards.Missions.StreetraceTakedownActivity2 = {
  FileVersion = "2",
  name = "StreetraceTakedownActivity2",
  title = "ID:244224",
  MissionID = "23248",
  ...
  cardInstances = {
    Actors = {
      Racer2 = {
        [1] = {
          ...
          routeName = "StreetraceTakedownActivity2Route",
    ...
    MissionSettings = {
      ["New MissionSettings"] = {
        [1] = {
          ...
          ["Start location"] = "StreetraceTakedownActivity2",
    ...
    SpawnTypes = {
      ["New Set position 4"] = {
        [1] = {
          ["Spawn location"] = "StreetraceTakedownActivity2Player",
