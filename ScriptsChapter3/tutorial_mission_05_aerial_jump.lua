...
cards.Missions["Tutorial Mission 05 Aerial Jump"] = {
  FileVersion = "2",
  name = "Tutorial Mission 05 Aerial Jump",
  title = "TUTORIAL MISSION 05 AERIAL JUMP ",
  MissionID = "5876",
  ...
  cardInstances = {
    ...
    MissionSettings = {
      ["New MissionSettings"] = {
        [1] = {
          ...
          ["Hud logic file"] = "Tutorial mission 05 aerial jump HUD",
          ["Disable traffic"] = false,
          ["Enable traffic at mission end"] = true,
          ["disablePlayerIgnoring"] = false,
          ["Audio logic file"] = "Shift tutorial level 2",
    ...
    MissionTypes = {
      ["New Tutorial mission 05 aerial jump"] = {
        [1] = {
          ["Tanner team"] = {
            instance = 1,
            type = "Teams",
